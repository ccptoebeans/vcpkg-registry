...
function(print_all_variables)
  ...
  foreach (_variableName ${_variableNames})
    message(STATUS "JOEJOEJOE ${_variableName}=${${_variableName}}")
  endforeach()
endfunction()
...
if(TARGET_TRIPLET MATCHES ".*universal-osx.*")
    ...
    foreach(_OSX_ARCH ${_ORIG_TARGET_ARCH})
        ...
        message(STATUS "JOEJOEJOE $ENV{CMAKE_EXE_LINKER_FLAGS}")
        message(STATUS "JOEJOEJOE $CACHE{CMAKE_EXE_LINKER_FLAGS}")
        set(VCPKG_TARGET_ARCHITECTURE ${_OSX_ARCH})
        set(VCPKG_OSX_ARCHITECTURES ${_OSX_ARCH})
        set(CMAKE_OSX_ARCHITECTURES ${_OSX_ARCH} CACHE STRING "" FORCE)
